 ...
 */
public abstract class StringFlagOnMethodCheck extends StringArgumentValueOnMethodCheck {
     ...
     */
    protected StringFlagOnMethodCheck(String methodName, String methodOwnerType, String constantValueToCheck, int... paramPositions) {
    ...
    protected void checkConstantValue(Optional<Object> optionalConstantValue, Tree reportTree, String constantValueToCheck) {
        if (optionalConstantValue.isPresent() && ((String) optionalConstantValue.get() + constantValueToCheck).equals(constantValueToCheck)) {
