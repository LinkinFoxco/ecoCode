...
public class GroovyHighlighterAndTokenizerTest {
  ...
  public void should_highlight_only_partially_if_file_can_not_be_lexed() throws Exception {
    ...
    System.out.println("LOGS START HERE");
    System.out.println(context.highlightingTypeAt(":Error.groovy", 0, 0));
    System.out.println(context.highlightingTypeAt(":Error.groovy", 1, 0));
    System.out.println(context.highlightingTypeAt(":Error.groovy", 2, 2));
    System.out.println(context.highlightingTypeAt(":Error.groovy", 3, 2));
